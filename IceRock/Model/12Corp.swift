...
func twelverCorpus(path: UIBezierPath, greenPath: UIBezierPath, imageView: UIImageView, numb: Int, but1: UIButton, but2: UIButton)  {
    ...
    if vhod == "вход 12 корпус" && numbImage == 1 && isOnlyVhod == 1 {
            ...
            path.addArc(withCenter: CGPoint(x: 0.498 * imageWidth, y: 0.9 * imageHeight), radius: 10, startAngle: 0, endAngle: CGFloat(2 * Double.pi), clockwise: true)
            path.move(to: CGPoint(x: 0.498 * imageWidth, y: 0.86 * imageHeight))
            ...
            path.addQuadCurve(to: CGPoint(x: 0.12 * imageWidth, y: 0.8 * imageHeight),
                              controlPoint: CGPoint(x: 0.12 * imageWidth, y: 0.6 * imageHeight))
        
            path.move(to: CGPoint(x: 0.12 * imageWidth, y: 0.8 * imageHeight))
            ...
            greenPath.addQuadCurve(to: CGPoint(x: 0.12 * imageWidth, y: 0.39 * imageHeight),
                                   controlPoint: CGPoint(x: 0.12 * imageWidth, y: 0.35 * imageHeight))
            ...
            DispatchQueue.global().async {
                ...
                if let coord = recognizeDigits(imageView: imageView, path: path) {
                    DispatchQueue.main.async {
                        ...
                        greenPath.move(to: CGPoint(x: 0.14 * imageWidth, y: 0.475 * imageHeight))
                        
                        path.addArc(withCenter: CGPoint(x: 0.175 * imageWidth, y: 0.8 * imageHeight), radius: 5, startAngle: 0, endAngle: CGFloat(2 * Double.pi), clockwise: true)
                        path.move(to: CGPoint(x: 0.175 * imageWidth, y: 0.78 * imageHeight))
                        path.addLine(to: CGPoint(x: 0.175 * imageWidth, y: 0.75 * imageHeight))
                        path.move(to: CGPoint(x: 0.175 * imageWidth, y: 0.75 * imageHeight))
                        ...
                        if (cabGo == "2-2" || cabGo == "2-4" || cabGo == "2-6" || cabGo == "2-8") ||
                            ...
                            path.addQuadCurve(to: CGPoint(x: 0.22 * imageWidth, y: 0.66 * imageHeight),
                                              controlPoint: CGPoint(x: 0.175 * imageWidth, y: 0.66 * imageHeight))
                            
                            path.move(to: CGPoint(x: 0.22 * imageWidth, y: 0.66 * imageHeight))
                            
                            if cabGo == "2-4" || cab == "2-4"  {
                                path.addQuadCurve(to: CGPoint(x: coord.x + 14 , y: coord.y - 12),
                                                  controlPoint: CGPoint(x: (coord.x) + 20 , y: 0.66 * imageHeight))
                            }
                            if cabGo == "2-2" || cab == "2-2" {
                                
                                path.addQuadCurve(to: CGPoint(x: coord.x , y: coord.y - 10),
                                                  controlPoint: CGPoint(x: coord.x  , y: 0.66 * imageHeight))
                            }
                            if cabGo == "2-6" || cab == "2-6" {
                                
                                path.addQuadCurve(to: CGPoint(x: 0.31 * imageWidth, y: 0.75 * imageHeight),
                                                  controlPoint: CGPoint(x: 0.31 * imageWidth, y: 0.66 * imageHeight))
                                
                                path.move(to: CGPoint(x: 0.31 * imageWidth, y: 0.75 * imageHeight))
                                
                                
                                path.addQuadCurve(to: CGPoint(x: 0.33 * imageWidth, y: 0.775 * imageHeight),
                                                  controlPoint: CGPoint(x: 0.31 * imageWidth, y: 0.775 * imageHeight))
                                
                                
                                
                                path.move(to: CGPoint(x: 0.33 * imageWidth, y: 0.775 * imageHeight))
                                
                                
                                
                                path.addQuadCurve(to: CGPoint(x: coord.x , y: coord.y - 11.5),
                                                  controlPoint: CGPoint(x: (coord.x)  , y: 0.775 * imageHeight))
                            }
                            if cabGo == "2-8" || cab == "2-8" {
                                ...
                                path.addQuadCurve(to: CGPoint(x: coord.x , y: coord.y - 12.5),
                                                  controlPoint: CGPoint(x: (coord.x)  , y: 0.775 * imageHeight))
                            }
                            
                               
                            
                            greenPath.addQuadCurve(to: CGPoint(x: 0.2 * imageWidth, y: 0.665 * imageHeight),
                        ...
                        if (cabGo ==  "2-17" || cabGo ==  "2-10Г" || cabGo ==  "2-10B" || cabGo ==  "2-10Б" || cabGo ==  "2-10" || cabGo ==  "2-10A" || cabGo ==  "2-26") ||
                            ...
                            if cabGo == "2-17" || cab == "2-17" {
                                path.addLine(to: CGPoint(x: 0.6 * imageWidth, y: 0.66 * imageHeight))
                                path.move(to: CGPoint(x: 0.6 * imageWidth, y: 0.66 * imageHeight))
                                path.addQuadCurve(to: CGPoint(x: coord.x  , y: coord.y + 10  ),
                                                  controlPoint: CGPoint(x: 0.67 * imageWidth, y: 0.66 * imageHeight))
                            } else if cabGo == "2-10Б" || cab == "2-10Б"{
                                
                                path.addLine(to: CGPoint(x: 0.6 * imageWidth, y: 0.66 * imageHeight))
                                path.move(to: CGPoint(x: 0.6 * imageWidth, y: 0.66 * imageHeight))
                                
                                path.addQuadCurve(to: CGPoint(x: 0.7 * imageWidth, y: 0.72 * imageHeight),
                                                  controlPoint: CGPoint(x: 0.7 * imageWidth, y: 0.66 * imageHeight))
                                path.move(to: CGPoint(x: 0.7 * imageWidth, y: 0.72 * imageHeight))
                                
                                
                                path.addQuadCurve(to: CGPoint(x: coord.x - 16  , y: coord.y - 22  ),
                                                  controlPoint: CGPoint(x: 0.7 * imageWidth, y: 0.76 * imageHeight))
                                ...
                                path.addQuadCurve(to: CGPoint(x: coord.x - 50  , y: coord.y - 22  ),
                                                  controlPoint: CGPoint(x: 0.7 * imageWidth, y: 0.76 * imageHeight))
                            } else if cabGo == "2-26" || cab == "2-26" {
                                path.addLine(to: CGPoint(x: 0.4 * imageWidth, y: 0.66 * imageHeight))
                                path.move(to: CGPoint(x: 0.4 * imageWidth, y: 0.66 * imageHeight))
                                path.addQuadCurve(to: CGPoint(x: coord.x  , y: coord.y + 31 ),
                                                  controlPoint: CGPoint(x: 0.45 * imageWidth, y: 0.66 * imageHeight))
                                
                            } else if cabGo == "2-10Г" || cab == "2-10Г" {
                                
                                path.addLine(to: CGPoint(x: 0.6 * imageWidth, y: 0.66 * imageHeight))
                                path.move(to: CGPoint(x: 0.6 * imageWidth, y: 0.66 * imageHeight))
                                path.addLine(to: CGPoint(x: coord.x - 23, y: 0.66 * imageHeight))
...
//
                                ...
                                path.addLine(to: CGPoint(x: 0.6 * imageWidth, y: 0.66 * imageHeight))
                                path.move(to: CGPoint(x: 0.6 * imageWidth, y: 0.66 * imageHeight))
                                path.addQuadCurve(to: CGPoint(x: coord.x  , y: coord.y - 18  ),
                                                  controlPoint: CGPoint(x: (coord.x) - 5, y: 0.66 * imageHeight))
                            }
            ...
            DispatchQueue.global().async {
                ...
                if let coord = recognizeDigits(imageView: imageView, path: path) {
                    DispatchQueue.main.async {
                        ...
                        greenPath.move(to: CGPoint(x: 0.13 * imageWidth, y: 0.435 * imageHeight))
                        ...
                        path.move(to: CGPoint(x: 0.17 * imageWidth, y: 0.78 * imageHeight))
                        ...
                        if (cabGo == "3-1" || cabGo == "3-3" || cabGo == "3-5" || cabGo == "3-7" || cabGo == "3-9" || cabGo == "3-11" || cabGo == "3-13" || cabGo == "3-15") ||
                            ...
                            if cabGo == "3-1" || cab == "3-1" {
                                greenPath.addQuadCurve(to: CGPoint(x: 0.08 * imageWidth, y: 0.45 * imageHeight),
                                                       controlPoint: CGPoint(x: 0.13 * imageWidth, y: 0.45 * imageHeight))
                                
                                path.addQuadCurve(to: CGPoint(x: coord.x + 8, y: 0.45 * imageHeight),
                            ...
                            if cabGo == "3-5" || cab == "3-5" {
                                ...
                                path.addLine(to: CGPoint(x: coord.x - 25, y: 0.45 * imageHeight))
                                
                                path.move(to: CGPoint(x: coord.x - 25, y: 0.45 * imageHeight))
                                
                                path.addQuadCurve(to: CGPoint(x: coord.x, y: coord.y + 13),
                                                  controlPoint: CGPoint(x: coord.x , y: 0.45 * imageHeight))
                            }
                        ...
                        if (cabGo == "3-4" || cabGo == "3-2") ||
                            ...
                            path.addQuadCurve(to: CGPoint(x: 0.2 * imageWidth, y: 0.65 * imageHeight),
                                              controlPoint: CGPoint(x: 0.17 * imageWidth, y: 0.65 * imageHeight))
                            
                            path.move(to: CGPoint(x: 0.2 * imageWidth, y: 0.65 * imageHeight))
                            
                            path.addQuadCurve(to: CGPoint(x: 0.24 * imageWidth, y: 0.7 * imageHeight),
                                              controlPoint: CGPoint(x: 0.24 * imageWidth, y: 0.65 * imageHeight))
                            
                            path.move(to: CGPoint(x: 0.24 * imageWidth, y: 0.7 * imageHeight))

                            path.addQuadCurve(to: CGPoint(x: cabGo == "3-4" ? coord.x - 15 : coord.x + 15 , y: coord.y ),
                        ...
                        if (cabGo == "3-16" || cabGo == "3-18" || cabGo == "3-20" || cabGo == "3-14") ||
                            ...
                            if cabGo == "3-14" || cab == "3-14" {
                                path.addQuadCurve(to: CGPoint(x: 0.38 * imageWidth, y: 0.75 * imageHeight),
                                                  controlPoint: CGPoint(x: 0.36 * imageWidth, y: 0.75 * imageHeight))
                                path.move(to: CGPoint(x: 0.38 * imageWidth, y: 0.75 * imageHeight))
                                path.addQuadCurve(to: CGPoint(x: coord.x, y: coord.y + 15),
                                                  controlPoint: CGPoint(x: coord.x, y: 0.75 * imageHeight))
                            }
                            if cabGo == "3-16" || cab == "3-16" {
                                path.addLine(to: CGPoint(x: 0.36 * imageWidth, y: coord.y - 15))
                            }
                        ...
                        if (cabGo == "3-22" || cabGo == "3-24" || cabGo == "3-26" || cabGo == "3-30" || cabGo == "3-32" || cabGo == "3-32A" || cabGo == "3-27") ||
                            ...
                            greenPath.addQuadCurve(to: CGPoint(x: 0.25 * imageWidth, y: 0.55 * imageHeight),
                                                   controlPoint: CGPoint(x: 0.14 * imageWidth, y: 0.55 * imageHeight))
                            
                            path.addQuadCurve(to: CGPoint(x: 0.25 * imageWidth, y: 0.55 * imageHeight),
                                              controlPoint: CGPoint(x: 0.17 * imageWidth, y: 0.55 * imageHeight))
                            path.move(to: CGPoint(x: 0.25 * imageWidth, y: 0.55 * imageHeight))
                            path.addLine(to: CGPoint(x: 0.55 * imageWidth, y: 0.55 * imageHeight))
                            path.move(to: CGPoint(x: 0.55 * imageWidth, y: 0.55 * imageHeight))
                            
                            path.addQuadCurve(to: CGPoint(x: 0.65 * imageWidth, y: 0.6 * imageHeight),
                                              controlPoint: CGPoint(x: 0.65 * imageWidth, y: 0.55 * imageHeight))
//
                            path.move(to: CGPoint(x: 0.65 * imageWidth, y: 0.6 * imageHeight))
                            
                            path.addQuadCurve(to: CGPoint(x: 0.7 * imageWidth, y: 0.68 * imageHeight),
                                              controlPoint: CGPoint(x: 0.65 * imageWidth, y: 0.68 * imageHeight))
                            
                            path.move(to: CGPoint(x: 0.7 * imageWidth, y: 0.68 * imageHeight))
                            
                            if (cabGo == "3-22" || cabGo == "3-24" || cabGo == "3-26") ||
                                (cab == "3-22" || cab == "3-24" || cab == "3-26") {
                                path.addQuadCurve(to: CGPoint(x: coord.x, y: coord.y - 15),
                                                  controlPoint: CGPoint(x: coord.x, y: 0.68 * imageHeight))
                            }
                            
                            if (cabGo == "3-30" || cabGo == "3-32" || cabGo == "3-32A") ||
                            (cab == "3-30" || cab == "3-32" || cab == "3-32A") {
                                
                                path.addLine(to: CGPoint(x: 0.85 * imageWidth, y: 0.68 * imageHeight))
                                path.move(to: CGPoint(x: 0.85 * imageWidth, y: 0.68 * imageHeight))

                                if cabGo == "3-30" || cab == "3-30" {
                                    
                                    path.addQuadCurve(to: CGPoint(x: 0.9 * imageWidth, y: 0.71 * imageHeight),
                                                      controlPoint: CGPoint(x: 0.9 * imageWidth, y: 0.68 * imageHeight))
                                    
                                    path.move(to: CGPoint(x: 0.9 * imageWidth, y: 0.71 * imageHeight))
                                    
                                    path.addQuadCurve(to: CGPoint(x: coord.x - 7, y: 0.73 * imageHeight),
                                                      controlPoint: CGPoint(x: 0.9 * imageWidth, y: 0.73 * imageHeight))
                                    
//
                                }
                                if (cabGo == "3-32" || cabGo == "3-32A") || (cab == "3-32" || cab == "3-32A") {
                                    path.addQuadCurve(to: CGPoint(x: 0.93 * imageWidth, y: 0.6 * imageHeight),
                                                      controlPoint: CGPoint(x: 0.93 * imageWidth, y: 0.68 * imageHeight))
                                    
                                    path.move(to: CGPoint(x: 0.93 * imageWidth, y: 0.6 * imageHeight))
                                    
                                    path.addQuadCurve(to: CGPoint(x: coord.x - 8, y: coord.y),
                                                      controlPoint: CGPoint(x: 0.93 * imageWidth, y: coord.y))
                            ...
                            if cabGo == "3-27" || cab == "3-27" {
                                path.addQuadCurve(to: CGPoint(x: coord.x, y: coord.y + 15),
                                                  controlPoint: CGPoint(x: 0.8 * imageWidth, y: 0.43 * imageWidth))
            ...
            DispatchQueue.global().async {
                ...
                if let coord = recognizeDigits(imageView: imageView, path: path) {
                    DispatchQueue.main.async {
                        ...
                        greenPath.move(to: CGPoint(x: 0.15 * imageWidth, y: 0.45 * imageHeight))
                        ...
                        path.move(to: CGPoint(x: 0.14 * imageWidth, y: 0.88 * imageHeight))
...
//                                          controlPoint: CGPoint(x: 0.14 * imageWidth, y: 0.62 * imageHeight))
                        ...
                        if (cabGo == "4-4" || cabGo == "4-10" || cabGo == "4-12" || cabGo == "4-14" || cabGo == "4-6" || cabGo == "4-20" || cabGo == "4-18" || cabGo == "4-23" || cabGo == "4-8") ||
                            ...
                            if cabGo == "4-4"  || cab == "4-4"  {
                                greenPath.addQuadCurve(to: CGPoint(x: 0.18 * imageWidth, y: 0.75 * imageHeight),
                                                       controlPoint: CGPoint(x: 0.15 * imageWidth, y: 0.55 * imageHeight))
                                
                                path.addQuadCurve(to: CGPoint(x: 0.18 * imageWidth, y: 0.75 * imageHeight),
                                                  controlPoint: CGPoint(x: 0.14 * imageWidth, y: 0.75 * imageHeight))
                                
                                path.move(to: CGPoint(x: 0.18 * imageWidth, y: 0.75 * imageHeight))
                            ...
                            if cabGo == "4-10" || cab == "4-10" {
                                ...
                                path.addQuadCurve(to: CGPoint(x: 0.2 * imageWidth, y: 0.65 * imageHeight),
                                                  controlPoint: CGPoint(x: 0.14 * imageWidth, y: 0.65 * imageHeight))
                                
                                path.move(to: CGPoint(x: 0.2 * imageWidth, y: 0.65 * imageHeight))
                                
                                path.addLine(to: CGPoint(x: coord.x - 10 , y: 0.65 * imageHeight))
                                
                                path.move(to: CGPoint(x: coord.x - 10 , y: 0.65 * imageHeight))

                                path.addQuadCurve(to: CGPoint(x: coord.x + 20, y: coord.y - 15),
                                                  controlPoint: CGPoint(x: coord.x + 20  , y: 0.65 * imageHeight))
                            }
                            ...
                            if cabGo == "4-12" || cab == "4-12" {
                                ...
                                path.addLine(to: CGPoint(x: coord.x - 30 , y: 0.65 * imageHeight))
                                
                                path.move(to: CGPoint(x: coord.x - 30 , y: 0.65 * imageHeight))

                                path.addQuadCurve(to: CGPoint(x: coord.x , y: coord.y - 19),
                                                  controlPoint: CGPoint(x: coord.x   , y: 0.65 * imageHeight))
                            }
                            ...
                            if cabGo == "4-14" || cab == "4-14" {
                                ...
                                path.addQuadCurve(to: CGPoint(x: coord.x , y: coord.y - 39),
                                                  controlPoint: CGPoint(x: coord.x   , y: 0.65 * imageHeight))
                            }
                            ...
                            if cabGo == "4-23" || cab == "4-23" {
                                greenPath.addQuadCurve(to: CGPoint(x: 0.3 * imageWidth, y: 0.55 * imageHeight),
                                                       controlPoint: CGPoint(x: 0.15 * imageWidth, y: 0.55 * imageHeight))
                                
                                path.addQuadCurve(to: CGPoint(x: 0.3 * imageWidth, y: 0.55 * imageHeight),
                                                  controlPoint: CGPoint(x: 0.14 * imageWidth, y: 0.55 * imageHeight))
                                
                                path.move(to: CGPoint(x: 0.3 * imageWidth, y: 0.55 * imageHeight))
                                
                                path.addLine(to: CGPoint(x: coord.x - 30, y: 0.55 * imageHeight))
                                
                                path.move(to: CGPoint(x: coord.x - 30, y: 0.55 * imageHeight))

                                path.addQuadCurve(to: CGPoint(x: coord.x , y: coord.y + 36),
                            ...
                            if cabGo == "4-8" || cab == "4-8" {
                                ...
                                path.addQuadCurve(to: CGPoint(x: coord.x - 5, y: coord.y - 19),
                                                  controlPoint: CGPoint(x: coord.x - 5  , y: 0.65 * imageHeight))
                            }
                        } else {
                            greenPath.addQuadCurve(to: CGPoint(x: 0.25 * imageWidth, y: 0.55 * imageHeight),
                                                   controlPoint: CGPoint(x: 0.15 * imageWidth, y: 0.55 * imageHeight))
...
//
            ...
            DispatchQueue.global().async {
                ...
                if let coord = recognizeDigits(imageView: imageView, path: path) {
                    DispatchQueue.main.async {
                        ...
                        path.addLine(to: CGPoint(x: 0.13 * imageWidth, y: 0.8 * imageHeight))
                        path.move(to: CGPoint(x: 0.13 * imageWidth, y: 0.8 * imageHeight))
                        greenPath.move(to: CGPoint(x: 0.15 * imageWidth, y: 0.38 * imageHeight))
                        ...
                        if (cabGo == "6-1" || cabGo == "6-3") || (cab == "6-1" || cab == "6-3") {
                            ...
                            greenPath.addQuadCurve(to: CGPoint(x: 0.17 * imageWidth, y: 0.55 * imageHeight),
                                              controlPoint: CGPoint(x: 0.13 * imageWidth, y: 0.55 * imageHeight))
                            path.addQuadCurve(to: CGPoint(x: 0.17 * imageWidth, y: 0.55 * imageHeight),
                                              controlPoint: CGPoint(x: 0.13 * imageWidth, y: 0.55 * imageHeight))
                            path.move(to: CGPoint(x: 0.17 * imageWidth, y: 0.55 * imageHeight))
                        }
                        
                        if (cabGo == "6-5" || cabGo == "6-7" || cabGo == "6-11" || cabGo == "6-13" || cabGo == "6-15") ||
                            (cab == "6-5" || cab == "6-7" || cab == "6-11" || cab == "6-13" || cab == "6-15") {
                            path.addLine(to: CGPoint(x: coord.x - 20, y: 0.55 * imageHeight))
                            path.move(to: CGPoint(x: coord.x - 20, y: 0.55 * imageHeight))
                            path.addQuadCurve(to: CGPoint(x: coord.x, y: coord.y + 20),
                                              controlPoint: CGPoint(x: coord.x , y: 0.55 * imageHeight))
                        }
    ...
    if (corp == "12" && etaz == 12  && corpGo == "12" && etazGo == 11) || (corp == "12" && etaz == 11  && corpGo == "12" && etazGo == 12) {
    ...
    if (corpGo == "12" && numbImage == 3 && etazGo == 11) || (corp == "12" && etaz == 11 && isOnlyVhod == 0 && numbImage == 0 ) || (corpGo == "12" && numbImage == 2 && etazGo == 11) || (corp == "12" && etaz == 11 && isOnlyVhod == 0 && numbImage == 1 ) {
        ...
        if (corpGo == "12" && numbImage == 3 && etazGo == 11) || (corpGo == "12" && numbImage == 2 && etazGo == 11) {
                ...
                if let coord = recognizeDigits(imageView: imageView, path: path) {
                    ...
                    DispatchQueue.main.async {
                        ...
                        if etaz == 11 && etazGo != 11 {
                            shapeLayerGreen.fillColor = .none
                            shapeLayerGreen.path = greenPath.cgPath
                            shapeLayerGreen.strokeColor = UIColor(red: 23/255, green: 88/255, blue: 226/255, alpha: 1).cgColor
                            shapeLayerGreen.lineWidth = 2.0
                            imageView.layer.addSublayer(shapeLayerGreen)
                            
                            shapeLayer.path = path.cgPath
                            shapeLayer.fillColor = .none
                            shapeLayer.strokeColor =    UIColor(red: 188/255, green: 213/255, blue: 250/255, alpha: 1).cgColor
                            shapeLayer.lineWidth = 2.0
                            imageView.layer.addSublayer(shapeLayer)
